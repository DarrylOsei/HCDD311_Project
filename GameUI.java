...
public class GameUI {
	...
	/**** Note:
	 * Certain code is in place for GUI color options for both Mac and Windows users 
     * ***/

	//CLASS (INHERITED) VARIABLES	
	Player plyr = new Player();
	public Inventory bp = new Inventory(); //video 3
	public InventoryUI ig; //video 3
    ...
    private JLabel lbldialog = new JLabel("ouput messages appears here");
    ...
    public void createUI() {
    	...
    	JFrame frame = new JFrame("Zombies @ PSU");
        ...
        imgPath = "./Zombie_Game/images/zombie_text.png";
        icon = new ImageIcon(new ImageIcon(imgPath).getImage().getScaledInstance(300, 75, Image.SCALE_SMOOTH));
        JLabel topBackground = new JLabel(icon);
        //JLabel titleLabel = new JLabel("Pirates of the Dead", SwingConstants.CENTER);
        //titleLabel.setFont(new Font("Serif", Font.BOLD, 36));
        topPanel.add(topBackground, BorderLayout.CENTER);
        ...
        btnItems.addActionListener(e -> {
            ig = new InventoryUI(bp); //show the item/inventory screen //video 3        
        });
        /************************************/
        ...
        // --- Image | Level 1 : Scene 1 ---
        imgPath = "./Zombie_Game/images/lvl1_scene1.png";
        icon = new ImageIcon(new ImageIcon(imgPath).getImage().getScaledInstance(900, 450, Image.SCALE_SMOOTH));
...
/************************************************/
        ...
        mapInteract.setBounds(60, 100, 150, 100);
        ...
        mapInteract.addActionListener(e -> {
            ...
            JOptionPane.showMessageDialog(null, "You discovered a Map of Level 1 !    ");
            //itm.pickup("map");
                                    
            //Define an Item on LevelOne and PUSH onto itemData
            Object[] loot = {"901", "Map", "Level 1", "Map of Level 1", 1, 1, "./Zombie_Game/images/level1map.png"};
            bp.pushItem(new InventoryItem(loot)); // PUSH it into the inventory
            // *** future thought:  search and remove map from level1Items array
        ...
        itemInteract.setBounds(80, 305, 60, 50);
        ...
        itemInteract.addActionListener(e -> {
            ...
            // Define an Item on LevelOne and PUSH onto itemData
            Object[] loot = {"004", "Health", "mHP", "Medium health pack", 1, 25, "./Zombie_Game/images/mHP.png"};
            bp.pushItem(new InventoryItem(loot)); // PUSH it into the inventory
            // *** search and remove this item from level1Items array
        ...
        livesInteract.setBounds(680, 345, 65, 50);
        ...
        livesInteract.addActionListener(e -> {
            ...
            //Define an Item on LevelOne and PUSH onto itemData
            Object[] loot = {"202", "Lives", "1up", "Increase lives by 1", 0, 1, "./Zombie_Game/images/1up.jpg"};
            bp.pushItem(new InventoryItem(loot)); // PUSH it into the inventory
        ...
        String wpnImgPath = "./Zombie_Game/images/fists_blue.png";
        ImageIcon wpnIcon = new ImageIcon(new ImageIcon(wpnImgPath).getImage().getScaledInstance(90, 120, Image.SCALE_SMOOTH));
        JLabel weaponLabel = new JLabel(wpnIcon);
        JLabel damageLabel = new JLabel("DMG: 5", SwingConstants.CENTER);
